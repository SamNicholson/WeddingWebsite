...
var map;
var center = new google.maps.LatLng(53.920727, -1.8151500);
...
var lodging_options = [
    new google.maps.LatLng(53.920727, -1.8151351) //Craiglands
];
...
function mapRedefine(){
    ...
    myWidth = window.innerWidth;
    if(myWidth <=767){
        var currCenter = new google.maps.LatLng(53.920727, -1.8151351);
        map.setZoom(14);
    }else if(myWidth = 768){
        var currCenter = new google.maps.LatLng(53.920727, -1.8151351);
        map.setZoom(14);
